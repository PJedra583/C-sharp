...
{
    /// <inheritdoc />
    public partial class PreparedModel3 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "drhouse@gmail.com", "Dr", "House" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Forte", "Ibuprom", "Przeciwbólowy" },
                    { 3, "Na sen", "Zolpidem", "Psychotropowy" }
                });

            migrationBuilder.InsertData(
                table: "Patient",
                columns: new[] { "IdPatient", "Birthdate", "Firstname", "Lastname" },
                values: new object[] { 1, new DateOnly(2002, 12, 2), "Jan", "Kowalski" });

            migrationBuilder.InsertData(
                table: "Prescription",
                columns: new[] { "IdPrescription", "Date", "DueDate", "IdDoctor", "IdPatient" },
                values: new object[] { 1, new DateOnly(2023, 12, 2), new DateOnly(2024, 12, 2), 1, 1 });
